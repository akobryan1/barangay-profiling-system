...
DATABASE SCHEMA: Within the repository, you will see the "SQL Database Creation Code" text file. Copy and Paste it to your SQL database which contains all the tables and a bit of placeholder data for testing purposes.
